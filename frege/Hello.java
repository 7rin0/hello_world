/*
  ...
  from HelloWorld.fr Do not edit this file! Instead, edit the source file and recompile.
*/
...
@Meta.FregePackage(
  source="HelloWorld.fr", time=1457995550269L, jmajor=1, jminor=7,
  imps={
...
final public static Func.U<RealWorld, Short> $main(final Lazy<PreludeBase.TList<String/*<Character>*/>> arg$1) {
  ...
  public static void main(final java.lang.String[] argv) {
    ...
    } finally { frege.run7.Concurrent.shutDownIfExists(); }
  }
}
